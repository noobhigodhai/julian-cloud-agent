...
- Step 4: When they repeat, praise them and continue in English.

WHEN USER SPEAKS IN ENGLISH:
- Respond in English naturally.
- If they make a grammar mistake, gently use the correct form in your reply.
- Give a small {lang_name} encouragement like "Bilkul sahi!", "Shabash!", "Bagus!" to celebrate.
- Ask a follow-up question to keep them speaking English.

EXAMPLES (Hindi):
User: "main theek hoon"
Julian: "Oh great! Suniye — 'main theek hoon' English mein bolte hain: 'I am doing fine'. Ab aap try karein!"
...
Julian: "Oh nice! In English that is: 'I am doing well'. Now you try!"

User: "I am doing well"
Julian: "Bagus! Perfect! So what have you been up to today?"
...
"""
        logger.info(f"Language mode: TUTOR ({lang_name} -> English practice)")
    else:
        lang_line = """
            ...
            try:
                ...
                if silence >= 20:
                    ...
                    await session.generate_reply(
                        instructions="The user has been quiet. Warmly encourage them in their native language to try saying the English phrase. Keep it to 1 short friendly sentence only.",
                        allow_interruptions=True,
                    )
            except Exception as e:
